...
of queries bouncing off to eliminate a group of items from the cache
...
you can always add new subtrees or create new trees and handle the cache at different leves.
